...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-radio-field', __webpack_require__(3));
  Vue.component('detail-nova-radio-field', __webpack_require__(6));
  Vue.component('form-nova-radio-field', __webpack_require__(9));
});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          { staticClass: "w-full", class: _vm.errorClasses },
            ...
            return _c(
              ...
              [
                _c("input", {
                  ...
                  domProps: {
                    value: option.name,
                    checked: _vm._q(_vm.value, option.name)
                  },
                  on: {
                    change: function($event) {
                      _vm.value = option.name
                    }
                  }
                }),
                _vm._v(" "),
